            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="p-2">
                                ...
                                @endif
                                <form class="form-horizontal" name="register" action="{{route('register.save')}}" method="POST">
                                    @csrf

                                    <div class="form-group">
                                        <label for="name">Name</label>
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Enter name" value="{{old('name')}}" data-rule-required="true" data-msg-required="Please enter your name" >
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="email" id="email" placeholder="Enter email" value="{{old('email')}}" data-rule-required="true" data-msg-required="Please enter your email"  data-rule-email="true" data-msg-email="Please enter a valid email">
                                        @error('email')
                    ...
                    <div class="mt-5 text-center">
                        <p>Have an account ? <a href="{{route('login')}}" class="font-weight-medium text-primary"> Sign In here</a> </p>
                    </div>
                    </div>
                </div>
            </div>
